...
build/clausesharer.o: src/clausesharer.cpp src/clausesharer.hpp | build
...
build/propagator.o: src/propagator.cpp src/clausesharer.hpp | build
...
build/solverprocess.o: src/solverprocess.cpp src/clausesharer.hpp | build
...
ams-dist: cadical/build/libcadical.a build/beamlookahead.o build/symbreak.o build/clausesharer.o build/worker.o build/manager.o build/statustracker.o build/propagator.o build/solverprocess.o src/main.cpp
